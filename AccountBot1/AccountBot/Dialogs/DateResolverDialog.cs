...
{
    public class DateResolverDialog : CancelDialog
    {
        private const string PromptMsgText = "Date of Birth";
        private const string RepromptMsgText = "I'm sorry, please enter a full travel date including Day Month and Year.";
